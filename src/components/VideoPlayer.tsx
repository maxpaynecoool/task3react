...
const VideoPlayer = () => {
  return (
    <div className="relative w-[70vw] 2xl:w-full">
      <img src="./images/videoPlayer.png" />
      <div className="absolute flex flex-col gap-5 bottom-10 left-10 right-10 text-white w-auto md:hidden">
        <div className="flex justify-between text-[1.375rem]">
        ...
        <div className="bg-[#FFFFFF33] h-2.5 rounded-full">
          <div className="bg-[#FF0000] h-2.5 w-[13vw] rounded-full">
          </div>
        </div>
          ...
          <div className="flex items-center gap-10">
            <div>
              <svg width="22" height="24" viewBox="0 0 22 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M8.8 0H0V24H8.8V0ZM22 0H13.2V24H22V0Z" fill="white"/>
              </svg>
            </div>
            <div>
            ...
            <div>
              <div className="flex items-center gap-5">
                ...
                <div className="bg-[#FFFFFF33] h-2 w-[5vw] rounded-full">
                  <div className="bg-[#FFFFFF] h-2 w-[2vw] rounded-full">
                  </div>
                </div>
              </div>
            </div>
      ...
      <div className="hidden absolute justify-between items-center gap-5 bottom-5 left-1.5 right-1.5 text-white py-2 px-4 w-auto rounded-xl bg-[#00000050] md:flex">
        <div>
          <svg width="12" height="12" viewBox="0 0 22 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd" clip-rule="evenodd" d="M8.8 0H0V24H8.8V0ZM22 0H13.2V24H22V0Z" fill="white"/>
          </svg>
        </div>
        <div className="flex items-center gap-2">
          <span className="text-[0.875rem] sm:text-[0.625rem]">
            1:34
          </span>
          <div className="bg-[#FFFFFF33] h-2 w-[50vw] rounded-full sm:w-[30vw]">
            <div className="bg-[#FF0000] h-2 w-[2vw] rounded-full">
            </div>
          </div>
          <span className="text-[0.875rem] sm:text-[0.625rem]">
            -10:00
